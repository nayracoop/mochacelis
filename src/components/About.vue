<template>
  <section id="about" class="bg-grey">
    <b-container>
      <b-row class="about">
        <b-col class="col-12 col-lg-6 section-heading">
          <h2 class="pb-2">
            <span class="initial">
